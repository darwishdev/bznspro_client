...
<template>
  <div class="contact-page">
    <div class="header text-left q-mb-xl">
      <div class="container">
        <h4 class="text-secondary before-line">تواصل معنا</h4>
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Cupiditate illum voluptatibus pariatur quod aliquid
          unde, quibusdam amet, recusandae iusto quos omnis. Assumenda soluta sunt velit corrupti ratione veniam aperiam
          ex.</p>
      </div>
    </div>
    <div class="container">
      <div class="contact-main flex q-my-xl q-pb-xl">
        <div class="form">
          <q-form @submit="onSubmit" @reset="onReset" class="q-gutter-md">
            ...
            <p class="">قم بملأ الفورم التالية و سنقوم بالتواصل معكم قريبا</p>

            <div class="row">

              <div class="col-6 q-pr-lg q-mb-lg">
                <q-input outlined v-model="name" label="Your name *" hint="Name and surname" lazy-rules
            ...
            <div class="flex ">
              <q-btn label="ارسال" type="submit" color="primary" class="full-width" />
            </div>
          </q-form>
        </div>
        <div class="contacts">
