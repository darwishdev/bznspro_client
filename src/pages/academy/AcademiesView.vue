...
const tabs = [
  ...
  { value: 'اهداف الدورة', key: 'goals' },
  { value: 'فيديو تعريفي', key: 'whattolearn' },
  { value: 'خطة الدورة', key: 'plan' },
];

const infoKeys = [
  { key: 'hours', value: 'عدد ساعات الدورة' },
  { key: 'date', value: 'تاريخ الدورة' },
  { key: 'time', value: 'توقيت الدورة' },
  { key: 'location', value: 'مكان الدورة' },
];
          ...
          <div class="tabs">
            ...
            <q-tab-panels v-model="tab" animated>
              ...
              <q-tab-panel name="goals">
                <div class="text-h6 q-my-lg">اهداف الدورة</div>
              ...
              <q-tab-panel name="plan">
                <div class="text-h6 q-my-lg">خطة الدورة</div>
        ...
        <q-splitter v-model="splitterModel" class="mobile-items" style="height: 250px">
          ...
          <template v-slot:after>
            <q-tab-panels v-model="tab" animated>
              ...
              <q-tab-panel name="goals">
                <div class="text-h6 ">اهداف الدورة</div>
              ...
              <q-tab-panel name="plan">
                <div class="text-h6 ">خطة الدورة</div>
